...
public class ReaderStateClientFactory {


    /**
     * Build Retrofit client for reader state endpoint
     * 
     * @param baseUrl
     * @return
     */
    public static ReaderStateClient getRetrofitClient(String baseUrl) {
        ...
        return retrofit.create(ReaderStateClient.class);
    }
}
