 ...
 ************************************************************************************** */
package org.cna.keyple.demo.sale.android.nfc.slave.data.remote.transport.wspolling.client_retrofit;

import org.cna.keyple.demo.sale.android.nfc.slave.data.remote.transport.WsPTransportDTO;
      ...
      call.enqueue(
          new Callback<KeypleDto>() {
            ...
            public void onResponse(Call<KeypleDto> call, Response<KeypleDto> response) {
              ...
              logger.trace(
                  "Polling for clientNodeId {} receive a httpResponse http code {}",
                  clientNodeId,
                  statusCode);
              if (statusCode == 200) {
            ...
            public void onFailure(Call<KeypleDto> call, Throwable t) {
              ...
              if (t instanceof ConnectException) {
                logger.error(
                    "Connection refused to server : {} , {}", t.getMessage(), t.getCause());
                ...
                logger.error(
                    "Unexpected error when poll() : {} , {}", t.getMessage(), t.getCause());
