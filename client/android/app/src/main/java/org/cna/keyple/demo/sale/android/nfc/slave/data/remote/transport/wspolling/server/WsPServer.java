 ...
 ************************************************************************************** */
package org.cna.keyple.demo.sale.android.nfc.slave.data.remote.transport.wspolling.server;
 ...
 *
 * <p>Sending {@link KeypleDto} to clients is achieve by a polling mechanism held by the web service
 * client (see {@link
 * org.eclipse.keyple.example.remote.transport.wspolling.client_retrofit.WsPRetrofitClientImpl#poll(String)}
 */
public class WsPServer implements ServerNode {
  ...
  private final Integer MAX_CONNECTION = 10;
  //private final HttpHandler keypleDTOEndpoint;
  //private final HttpHandler pollingEndpoint;
  ...
  public void start() {
    logger.info(
        "Starting Http Web Polling Server on http://{}:{}", inet.getHostName(), inet.getPort());
