...
public class AsyncNodeServerAdapterTest extends AbstractAsyncNodeAdapterTest {

  AsyncEndpointServerSpi endpoint;
  AsyncNodeServerAdapter node;
  ...
  public void setUp() {
    super.setUp();
    endpoint = mock(AsyncEndpointServerSpi.class);
    node = new AsyncNodeServerAdapter(handler, endpoint, 1);
  }
